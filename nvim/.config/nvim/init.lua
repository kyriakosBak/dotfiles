	...
	{ -- Useful plugin to show you pending keybinds.
		...
		config = function() -- This is the function that runs, AFTER loading
			...
			require("which-key").add({
				...
				{ "<leader>c_", hidden = true }, -- Recommended by :checkhealth

				-- [D]ocument
				{ "<leader>d", group = "[D]ocument" },
				{ "<leader>d_", hidden = true }, -- Recommended by :checkhealth

				-- [R]ename
				{ "<leader>r", group = "[R]ename" },
				{ "<leader>r_", hidden = true }, -- Recommended by :checkhealth

				-- [S]earch
				{ "<leader>s", group = "[S]earch" },
				{ "<leader>s_", hidden = true }, -- Recommended by :checkhealth

				-- [W]orkspace
				{ "<leader>w", group = "[W]orkspace" },
				{ "<leader>w_", hidden = true }, -- Recommended by :checkhealth
			})
		end,
	},
